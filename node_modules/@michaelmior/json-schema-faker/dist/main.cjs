...
function objectType(value, path, resolve2, traverseCallback) {
  ...
  const allowsAdditional = value.additionalProperties !== false && !option_default("noAdditional");
  ...
  const additionalProperties = allowsAdditional ? value.additionalProperties === true ? anyType : value.additionalProperties : value.additionalProperties && !option_default("Additional");
