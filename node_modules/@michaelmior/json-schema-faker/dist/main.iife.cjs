...
laborum`.split(/\W/);
  ...
  function objectType(value, path, resolve2, traverseCallback) {
    ...
    const allowsAdditional = value.additionalProperties !== false && option_default("generateAdditional");
    ...
    const additionalProperties = allowsAdditional ? value.additionalProperties === true ? anyType : value.additionalProperties : value.additionalProperties && option_default("generateAdditional");
